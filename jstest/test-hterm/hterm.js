...
lib.colors.hexToRGB = function(arg) {
  function convert(hex) {
    var re = hex.length == 4 ? lib.colors.re_.hex16 : lib.colors.re_.hex24;
...
lib.TestManager.TestRun.prototype.runNextTest_ = function() {
  ...
  try {
    ...
    this.log.println(
      "Unexpected exception during test preamble: " + (ex.stack ? ex.stack : ex)
    );
    this.log.popPrefix();
    this.log.println("}");
...
hterm.Frame.prototype.show = function() {
  ...
  iframe.style.cssText =
    "display: -webkit-flex;" + "-webkit-flex: 1;" + "width: 100%";
...
hterm.ScrollPort.prototype.measureCharacterSize = function(opt_weight) {
  ...
  var size = new hterm.Size(
    rulerSize.width / this.ruler_.textContent.length,
    rulerSize.height
  );
...
hterm.Terminal.prototype.decorate = function(div) {
  ...
  style.textContent =
    ...
    "  text-align: center;" +
    "  width: " +
    this.scrollPort_.characterSize.width * 2 +
    "px;" +
    "}";
...
hterm.Terminal.prototype.syncCursorPosition_ = function() {
  ...
  this.cursorNode_.style.top =
    ...
    "px";
  this.cursorNode_.style.left =
    this.scrollPort_.characterSize.width * this.screen_.cursorPosition.column +
    "px";
...
hterm.TextAttributes.prototype.createContainer = function(opt_textContent) {
  ...
  if (this.blink) style.fontStyle = "italic";
 ...
 */
hterm.VT.CharacterMap.maps["C"] = hterm.VT.CharacterMap.maps[
  "5"
 ...
 */
hterm.VT.CharacterMap.maps["E"] = hterm.VT.CharacterMap.maps[
  "6"
 ...
 */
hterm.VT.CharacterMap.maps["7"] = hterm.VT.CharacterMap.maps[
  "H"
...
lib.resource.add("hterm/changelog/version", "text/plain", "1.56" + "");

lib.resource.add("hterm/changelog/date", "text/plain", "2015-06-16" + "");
